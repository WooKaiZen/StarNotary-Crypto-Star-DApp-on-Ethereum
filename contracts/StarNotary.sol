...
contract StarNotary is ERC721 {
    ...
    //constructor() ERC721("WooKaiZen Token", "WKZ") {}
	
	string public constant name = 'WooKaiZen Token';
    string public constant symbol = 'WKZ';
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
		...
		require(star1owner == msg.sender || star2owner == msg.sender, "You can't exchange a star you don't own");
